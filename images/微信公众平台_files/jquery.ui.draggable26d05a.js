...
});define("common/wx/mpEditor/editor_all_min.js",["biz_web/lib/store.js","common/lib/colorpicker.js","tpl/mpEditor/layout.html.js"],function(e){
function t(e,t,n){
var i;
...
tabindex:"tabIndex",
readonly:"readOnly"
},h=c.listToMap(["-webkit-box","-moz-box","block","list-item","table","table-row-group","table-header-group","table-footer-group","table-row","table-column-group","table-column","table-cell","table-caption"]),p=a.domUtils={
NODE_ELEMENT:1,
NODE_DOCUMENT:9,
NODE_TEXT:3,
NODE_COMMENT:8,
...
f.appendChild(u));c&&c!==r&&c!==h[b];)v=c.nextSibling,f.appendChild(t?c:c.cloneNode(!0)),
c=v;
f=u;
}
...
t&&r.deleteData(0,s)):(u=y.cloneNode(!1),f.appendChild(u)),b!=g||!m[g])for(;c&&c!==o;)y=c.previousSibling,
f.insertBefore(t?c:c.cloneNode(!0),f.firstChild),c=y;
f=u;
}
return t&&e.setStartBefore(h[g]?m[g]?h[g]:m[g-1]:h[g-1]).collapse(!0),n&&p.remove(n),
i&&p.remove(i),d;
}
function o(e,t){
try{
...
var l,d=0,u=p.fillChar,m=a.Range=function(e){
var t=this;
...
var b;
if("span"==e&&t.style&&/text\-decoration/.test(t.style)&&(b=p.findParentByTagName(c,"a",!0))?(p.setAttributes(b,t),
p.remove(c,!0),c=b):(p.mergeSibling(c),p.clearEmptySibling(c)),p.mergeChild(c,t),
...
h=l.index;
try{
if(h>g&&n(b,e.slice(g,h)),l[3])b=i(b,l[3].toLowerCase(),l[4]);else if(l[1]){
if("root"!=b.type){
...
var m,h,u,v,b,y=0;
i.inFillChar()&&(m=i.startContainer,p.isFillChar(m)?(i.setStartBefore(m).collapse(!0),
p.remove(m)):p.isFillChar(m,!0)&&(m.nodeValue=m.nodeValue.replace(g,""),i.startOffset--,
i.collapsed&&i.collapse(!0)));
var C=p.findParentByTagName(i.startContainer,"li",!0);
if(C){
for(var N,x;m=o.firstChild;){
for(;m&&(3==m.nodeType||!p.isBlockElm(m)||"HR"==m.tagName);)N=m.nextSibling,i.insertNode(m).collapse(),
l.push(m),x=m,m=N;
...
var w;
N=m.nextSibling,w=r.document.createElement("li"),p.insertAfter(C,w),w.appendChild(m),
...
for(;m=o.firstChild;){
if(y){
for(var E=r.document.createElement("p");m&&(3==m.nodeType||!f.$block[m.tagName]);)b=m.nextSibling,
E.appendChild(m),m=b;
E.firstChild&&(m=E);
}
...
if(f[h.tagName][m.nodeName])for(v=m.parentNode;v!==h;)u=v,v=v.parentNode;else u=h;
p.breakParent(m,u||v);
var u=m.previousSibling;
p.trimWhiteTextNode(u),u.childNodes.length||p.remove(u),!s.ie&&(N=m.nextSibling)&&p.isBlockElm(N)&&N.lastChild&&!p.isBr(N.lastChild)&&N.appendChild(r.document.createElement("br")),
y=1;
}
var N=m.nextSibling;
...
if(m=i.startContainer,b&&p.isBr(b)&&p.remove(b),p.isBlockElm(m)&&p.isEmptyNode(m))if(b=m.nextSibling)p.remove(m),
1==b.nodeType&&f.$block[b.tagName]&&i.setStart(b,0).collapse(!0).shrinkBoundary();else try{
...
r(s)&&"text-decoration"!=n&&p.remove(s,!0)):p.remove(s,!0):f.$tableContent[s.tagName]||f.$list[s.tagName]||(p.removeAttributes(s,m),
r(s)&&p.remove(s,!0))),s=a;
}
var l=d.start.parentNode;
!p.isBlockElm(l)||f.$tableContent[l.tagName]||f.$list[l.tagName]||p.removeAttributes(l,m),
l=d.end.parentNode,d.end&&p.isBlockElm(l)&&!f.$tableContent[l.tagName]&&!f.$list[l.tagName]&&p.removeAttributes(l,m),
e.moveToBookmark(d).moveToBookmark(t);
for(var h,v=e.startContainer,b=e.collapsed;1==v.nodeType&&p.isEmptyNode(v)&&f.$removeEmpty[v.tagName];)h=v.parentNode,
e.setStartBefore(v),e.startContainer===e.endContainer&&e.endOffset--,p.remove(v),
v=h;
if(!b)for(v=e.endContainer;1==v.nodeType&&p.isEmptyNode(v)&&f.$removeEmpty[v.tagName];)h=v.parentNode,
e.setEndBefore(v),p.remove(v),v=h;
}
var d,c,u=new RegExp("^(?:"+(t||this.options.removeFormatTags).replace(/,/g,"|")+")$","i"),m=n?[]:(i||this.options.removeFormatAttributes).split(","),h=new a.Range(this.document),g=function(e){
return 1==e.nodeType;
};
...
e.enlarge(!0);
for(var d,u=e.createBookmark(),f=p.getNextDomNode(u.start,!1,l),m=e.cloneRange();f&&!(p.getPosition(f,u.end)&p.POSITION_FOLLOWING);)if(3!=f.nodeType&&t(f))f=p.getNextDomNode(f,!0,l);else{
for(m.setStartBefore(f);f&&f!==u.end&&!t(f);)d=f,f=p.getNextDomNode(f,!1,null,function(e){
return!t(e);
});
m.setEndAfter(d),a=e.document.createElement(i),o&&(p.setAttributes(a,o),r&&"customstyle"==r&&o.style&&(a.style.cssText=o.style)),
a.appendChild(m.extractContents()),p.isEmptyNode(a)&&p.fillChar(e.document,a),m.insertNode(a);
var h=a.parentNode;
t(h)&&!p.isBody(a.parentNode)&&-1==c.indexOf(n,h.tagName)&&(r&&"customstyle"==r||(h.getAttribute("dir")&&a.setAttribute("dir",h.getAttribute("dir")),
...
h.style.padding&&!a.style.padding&&(a.style.padding=h.style.padding)),o&&/h\d/i.test(h.tagName)&&!/h\d/i.test(a.tagName)?(p.setAttributes(h,o),
r&&"customstyle"==r&&o.style&&(h.style.cssText=o.style),p.remove(a,!0),a=h):p.remove(a.parentNode,!0)),
f=-1!=c.indexOf(n,h.tagName)?h:a,f=p.getNextDomNode(f,!1,l);
}
...
execCommand:function(e,t){
var n=this,i=n.selection.getRange(),o=p.findParentByTagName(i.startContainer,"pre",!0);
...
o=n.document.getElementById("coder"),p.removeAttributes(o,"id");
...
var t=e.selection.getRange(),n=p.findParentByTagName(t.startContainer,"pre",!0);
if(n){
...
t.insertNode(l),t.insertNode(e.document.createTextNode(p.fillChar)),t.setStartAfter(l),
n=l.previousSibling;
...
if(n){
for(var c="";n&&"BR"!=n.nodeName&&new RegExp("^[ "+p.fillChar+"]*$").test(n.nodeValue);)c+=n.nodeValue,
n=n.nextSibling;
if("BR"!=n.nodeName){
...
if(n){
for(var c="";n&&"BR"!=n.nodeName&&new RegExp("^[\\s"+p.fillChar+"]*$").test(n.nodeValue);)c+=n.nodeValue,
n=n.nextSibling;
...
var i=e.selection.getRange(),o=p.findParentByTagName(i.startContainer,"pre",!0);
if(o){
...
return p.fillNode(e.document,r),o.parentNode.insertBefore(r,o),p.remove(o),i.setStart(r,0).setCursor(!1,!0),
...
g&&(r.style.cssText="list-style-type:"+g),r.className=c.trim(r.className.replace(/list-paddingleft-\w+/,""))+" list-paddingleft-"+h,
...
if(m&&h&&m===h){
if(!u.collapsed){
if(m=p.findParentByTagName(u.startContainer,"li",!0),h=p.findParentByTagName(u.endContainer,"li",!0),
!m||!h||m!==h){
...
next=d.nextSibling,C=l.document.createElement("p"),p.fillNode(l.document,C),b=d.parentNode,
w&&next?(u.setStart(next,0).collapse(!0).select(!0),p.remove(d)):((w||next)&&w?d.parentNode.parentNode.insertBefore(C,b.nextSibling):b.parentNode.insertBefore(C,b),
p.remove(d),b.firstChild||p.remove(b),u.setStart(C,0).setCursor()),void n();
}
if(d=p.findParentByTagName(u.startContainer,"li",!0)){
if(p.isEmptyBlock(d)){
v=u.createBookmark();
var b=d.parentNode;
if(d!==b.lastChild?(p.breakParent(d,b),r(d)):(b.parentNode.insertBefore(d,b.nextSibling),
p.isEmptyNode(b)&&p.remove(b)),!f.$list[d.parentNode.tagName])if(p.isBlockElm(d.firstChild))p.remove(d,!0);else{
...
var x=N.nextSibling;
y=x.firstChild,y||(C=l.document.createElement("p"),p.fillNode(l.document,C),x.appendChild(C),
y=C),p.isEmptyNode(y)&&(y.innerHTML="",p.fillNode(l.document,y)),u.setStart(y,0).collapse(!0).shrinkBoundary().select(),
p.remove(N);
...
return p.breakParent(m,b),r(m),l.fireEvent("contentchange"),u.setStart(m,0).setCursor(!1,!0),
...
p.isBlockElm(y))if(p.isEmptyNode(y))for(w.appendChild(y),u.setStart(y,0).setCursor(!1,!0);d.firstChild;)w.appendChild(d.firstChild);else N=l.document.createElement("span"),
...
var b=d.parentNode,v=u.createBookmark();
if(p.isTagNode(b.parentNode,"ol ul"))b.parentNode.insertBefore(d,b),p.isEmptyNode(b)&&p.remove(b);else{
...
var g=h.parentNode,v=l.document.createElement(g.tagName),b=c.indexOf(m[v.tagName],t(g)||p.getComputedStyle(g,"list-style-type")),y=b+1==m[v.tagName].length?0:b+1,C=m[v.tagName][y];
...
if(r)for(;(r=r.firstChild)&&"LI"!=r.tagName;);else r=p.getNextDomNode(h,!1,null,function(e){
return e!==s;
});
break;
}
...
if(e(r))return!0;
var g=r.parentNode,v=l.document.createElement(g.tagName),b=c.indexOf(m[v.tagName],t(g)||p.getComputedStyle(g,"list-style-type"));
...
var h,g,v,b,y=s.createBookmark(!0),C=a(r.document.getElementById(y.start)),N=0,x=a(r.document.getElementById(y.end)),w=0;
if(C||x){
...
m.appendChild(x),p.breakParent(b,h),p.isEmptyNode(b.previousSibling)&&p.remove(b.previousSibling),
p.isEmptyNode(b.nextSibling)&&p.remove(b.nextSibling);
...
if(C){
for(;C;){
if(b=C.nextSibling,p.isTagNode(C,"ol ul"))m.appendChild(C);else{
...
h.parentNode.insertBefore(m,h.nextSibling),p.isEmptyNode(h)?(s.setStartBefore(h),
p.remove(h)):s.setStartAfter(h),N=1;
}
...
p.moveChild(x,L),m.appendChild(L),p.remove(x),g.parentNode.insertBefore(m,g),s.setEndBefore(g),
...
P&&O(P)&&(b=p.getNextDomNode(A,!1,l),b&&p.isBookmarkNode(b)&&(P=p.getNextDomNode(b,!1,l),
A=b)),M.setEndAfter(A),P=p.getNextDomNode(A,!1,l);
...
s.moveToBookmark(D).collapse(!0),v=r.document.createElement(u),o(v,n),v.appendChild(m),
...
if(v.innerHTML=m+p.fillChar,u.collapsed)u.insertNode(v.cloneNode(!0).firstChild).setCursor(!0);else if(l=p.findParent(u.startContainer,y),
d=p.findParent(u.endContainer,y),l&&d&&l===d)u.deleteContents(),u.insertNode(v.cloneNode(!0).firstChild).setCursor(!0);else{
var b=u.createBookmark(),y=function(e){
return p.isBlockElm(e)&&!c[e.tagName.toLowerCase()];
};
u.enlarge(!0);
for(var C=u.createBookmark(),N=p.getNextDomNode(C.start,!1,y);N&&!(p.getPosition(N,C.end)&p.POSITION_FOLLOWING);)N.insertBefore(v.cloneNode(!0).firstChild,N.firstChild),
N=p.getNextDomNode(N,!1,y);
...
v||b&&s.ie?("absolute"!=f.style.position&&(f.style.position="absolute"),f.style.top=(document.body.scrollTop||document.documentElement.scrollTop)-m+d+"px"):(s.ie7Compat&&C&&(C=!1,
...
if(l){
var u,f,m,h,g=UE.ui.uiUtils,v=s.ie&&s.version<=6,b=s.quirks,y=document.createElement("div"),C=!0,N=c.defer(function(){
o();
},s.ie?200:100,!0);
r.addListener("destroy",function(){
p.un(window,["scroll","resize"],o),r.removeListener("keydown",N);
}),r.addListener("ready",function(){
e(r)&&(h=g.getClientRect,f=r.ui.getDom("toolbarbox"),m=h(f).top,u=f.style.cssText,
y.style.height=f.offsetHeight+53+"px",v&&t(),p.on(window,["scroll","resize"],o),
...
for(v=0;n>v;v++)for(b=0;o>b;b++)void 0===this.indexTable[v][b]&&(s=t[v],d=s.cells[s.cells.length-1],
d=d?d.cloneNode(!0):this.table.ownerDocument.createElement("td"),this.setCellContent(d),
1!==d.colSpan&&(d.colSpan=1),1!==d.rowSpan&&(d.rowSpan=1),s.appendChild(d),this.indexTable[v][b]={
rowIndex:v,
...
var y=p.getElementsByTagName(this.table,"td"),C=[];
...
r>m?(d=r-m-1,p.insertAfter(f.cells[d],l)):f.cells.length&&f.insertBefore(l,f.cells[0]),
o+=1;
}
r+=s.colSpan||1;
}
var h=[],g={};
for(r=0;i>r;r++){
var v=n[r].rowIndex,b=n[r].cellIndex,y=v+"_"+b;
...
if(i.isFullCol()){
var c,u,f=p.getElementsByTagName(r,"caption"),m=p.getElementsByTagName(r,"th");
f.length>0&&(c=f[0].offsetHeight),m.length>0&&(u=m[0].offsetHeight),o=r.offsetHeight-(c||0)-(u||0),
t=0==m.length?i.rowsNum:i.rowsNum-1;
}else{
for(var h=i.cellsRange.beginRowIndex,g=i.cellsRange.endRowIndex,v=0,b=p.getElementsByTagName(r,"tr"),y=h;g>=y;y++)o+=b[y].offsetHeight,
v+=1;
t=v;
}
...
if(Y&&(W.body.style.webkitUserSelect="none",(Math.abs(J.x-t.clientX)>G||Math.abs(J.y-t.clientY)>G)&&(E(),
Y=!1,Q=0,S(t))),st&&ft)return Q=0,W.body.style.webkitUserSelect="none",W.selection.getNative()[s.ie9below?"empty":"removeAllRanges"](),
n=r(t),v(W,!0,st,n,o),void("h"==st?ut.style.left=h(ft,t)+"px":"v"==st&&(ut.style.top=g(ft,t)+"px"));
if(o){
if(W.fireEvent("excludetable",o)===!0)return;
n=r(t);
var a=b(o,n),l=p.findParentByTagName(o,"table",!0);
if(m(l,o,t,!0)){
...
var n;
if(n=b(t,r(e))){
if(H(W),"h1"==n)if(n="h",m(p.findParentByTagName(t,"table"),t,e))W.execCommand("adaptbywindow");else if(t=tt(t).getPreviewCell(t)){
...
var W=this,z=null,j=null,X=5,Y=!1,K=5,G=10,Q=0,J=null,Z=360,et=UE.UETable,tt=function(e){
...
if(13==s){
var h=a.selection.getRange(),d=p.findParentByTagName(h.startContainer,"caption",!0);
if(d){
...
if(u){
var g=u.rows[0].cells[0],v=p.findParentByTagName(a.selection.getStart(),["td","th"],!0),b=u.previousSibling;
if(g===v&&(!b||1==b.nodeType&&"TABLE"==b.tagName)&&p.isStartInblock(h)){
var y=p.findParent(a.selection.getStart(),function(e){
return p.isBlockElm(e);
},!0);
y&&(/t(h|d)/i.test(y.tagName)||y===v.firstChild)&&(a.execCommand("insertparagraphbeforetable"),
p.preventDefault(i));
}
}
}
...
var m,h,d=l.selection.getRange(),g=p.findParentByTagName(d.startContainer,["td","th"],!0);
if(g){
var v=tt(g);
if(r){
...
for(var y,C=0;y=e[C++];){
m=g;
for(var N,w=0;N=y[w++];)if(g)g.innerHTML=N.innerHTML,N.getAttribute("width")&&g.setAttribute("width",N.getAttribute("width")),
...
N.style.cssText&&(g.style.cssText=N.style.cssText),h=g,g=g.nextSibling;else{
var S=N.cloneNode(!0);
...
for(var y,C=0;y=e[C++];){
for(var N,x=f.insertRow(f.rows.length),w=0;N=y[w++];)S=et.cloneCell(N,null,!0),p.removeAttributes(S,["class"]),
x.appendChild(S);
2==w&&S.rowSpan>1&&(S.rowSpan=1);
}
var B=it(l),_=l.body.offsetWidth-(ht?2*parseInt(p.getComputedStyle(l.body,"margin-left"),10):0)-2*B.tableBorder-(l.options.offsetWidth||0);
...
for(var d,c,u,f=-2,m=-2,g=0;u=n[g];g++)o(u)?s.setStart(u,0).setCursor(!1,!0):s.selectNode(u).select(!0),
...
var g=p.getPosition(m,i.start),v=p.getPosition(m,i.end);
...
var i=r.editor.utils,o=r.editor.ui.uiUtils,a=r.editor.ui.UIBase,l=r.editor.dom.domUtils,d=[],c=e("tpl/mpEditor/layout.html.js");
...
t.options.wordCount&&(l.on(t.document,"click",n),t.ui.getDom("wordcount").innerHTML=t.getLang("wordCountTip")),
...
for(;"BODY"!=n.tagName;)n.style.position=d.shift(),n=n.parentNode;
...
o.setViewportOffset(this.getDom(),{
left:0,
...
_scale:function(){
function e(){
p=l.getXY(a),g||(g=r.options.minFrameHeight+c.offsetHeight+u.offsetHeight),m.style.cssText="position:absolute;left:0;display:;top:0;background-color:#41ABFF;opacity:0.4;filter: Alpha(opacity=40);width:"+a.offsetWidth+"px;height:"+a.offsetHeight+"px;z-index:"+(r.options.zIndex+1),
l.on(o,"mousemove",t),l.on(d,"mouseup",n),l.on(o,"mouseup",n);
}
function t(e){
i();
...
function n(){
h&&(h=!1,r.ui._actualFrameWidth=m.offsetWidth-2,a.style.width=r.ui._actualFrameWidth+"px",
r.setHeight(m.offsetHeight-u.offsetHeight-c.offsetHeight-2)),m&&(m.style.display="none"),
i(),l.un(o,"mousemove",t),l.un(d,"mouseup",n),l.un(o,"mouseup",n);
}
function i(){
s.ie?o.selection.clear():window.getSelection().removeAllRanges();
}
var o=document,r=this.editor,a=r.container,d=r.document,c=this.getDom("toolbarbox"),u=this.getDom("bottombar"),f=this.getDom("scale"),m=this.getDom("scalelayer"),h=!1,p=null,g=0,v=r.options.minFrameWidth,b=0,y=0,C=0,N=0;
...
var t,n=this,i=r.editor.dom.domUtils,o=function(){
...
}),new t(n.options),e&&(e.constructor===String&&(e=document.getElementById(e)),e&&e.getAttribute("name")&&(n.options.textarea=e.getAttribute("name")),
e&&/script|textarea/gi.test(e.tagName))){
var i=document.createElement("div");
e.parentNode.insertBefore(i,e);
var r=e.value||e.innerHTML;
n.options.initialContent=/^[\t\r\n ]*$/.test(r)?n.options.initialContent:r.replace(/>[\n\r\t]+([ ]{4})+/g,">").replace(/[\n\r\t]+([ ]{4})+</g,"<").replace(/>[\n\r\t]+</g,"><"),
e.className&&(i.className=e.className),e.style.cssText&&(i.style.cssText=e.style.cssText),
/textarea/i.test(e.tagName)?(n.textarea=e,n.textarea.style.display="none"):(e.parentNode.removeChild(e),
e.id&&(i.id=e.id)),e=i,e.innerHTML="";
}
