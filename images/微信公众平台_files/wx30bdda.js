...
function r(o,e,r){
var t,a;
r&&"object"==typeof r?(t=r.done,a=r.fail):t=r,"string"==typeof e&&e.length>0&&(e={
url:e
}),e=$.extend(!0,{},c,{
type:o,
data:{
...
responseText:e.mock
}),e.mock.url=e.mock.url||e.url,$.mockjax(e.mock)),e.mask&&($.isPlainObject(e.mask)?n.show(e.mask):n.show());
var i=$.ajax(e);
...
wx.moonsafe_report_var(o)),t&&t(o);
}).fail(function(o,r,n){
a&&a(r),s.error(r,e),m.trigger("xhrError",o,r,n,e);
}).always(function(){
e.mask&&n.hide();
}),i;
}
var n=o("common/qq/mask.js"),t=o("common/wx/dialog.js"),a=o("common/wx/Tips.js"),s=o("common/wx/cgiReport.js");
...
e.show=function(o,e){
var r=i[o.base_resp.ret]||"系统繁忙，请稍后尝试！";
return 0==o.base_resp.ret?void(e?t.show({
type:"succ",
msg:"系统提示|"+r
}):a.suc(r)):void(e?t.show("系统错误|"+r):a.err(r));
...
var r=i[e.ret];
if(r)e.showMsg&&a.err(r);else{
var n=new Image;
n.src="/mp/unknow_ret_report?uin={uin}&id={id}&key={key}&url={url}&location={location}&ret={ret}&method=get&action=report".format(e),
